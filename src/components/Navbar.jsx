...
function Navbar() {
  ...
  return (
    <nav className="bg-indigo-200 text-lg w-full md:static border-b-2 py-6">
            ...
            {navigation.map((item, idx) => (
              <li key={idx} className="text-gray-700 font-semibold">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "text-white bg-indigo-600 px-2 py-1 rounded-md"
                      : "text-gray-700 px-2 py-1 hover:text-indigo-600"
                  }
